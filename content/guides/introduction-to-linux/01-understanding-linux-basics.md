...
1. **1969-1970s**: Unix was developed at Bell Labs (AT&T) by Ken Thompson, Dennis Ritchie, and others
2. **1983**: Richard Stallman initiated the GNU Project to create a free Unix-like operating system
3. **1991**: Linus Torvalds created the Linux kernel as a hobby project while studying at the University of Helsinki
4. **1992-1993**: Linux was combined with GNU tools, creating the first Linux distributions
5. **1994-Present**: Linux grew from a hobbyist project to powering most of the internet's infrastructure, Android phones, and numerous other systems
...
1. **Freedom to use, study, modify, and share**: Users have control over their software
2. **Collaboration**: Development happens in public with diverse contributors
3. **Transparency**: Code and development processes are visible to everyone
4. **Meritocracy**: Ideas are judged on their merits rather than who proposed them
